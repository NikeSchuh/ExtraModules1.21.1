...
public class ColorUtil {
    ...
    public static int rainbowColor(float time) {
        return NikesMath.hsvToRgb((float) ((Math.sin(time) + 1F) / 2F), 1F, 1F);
    }
    ...
    public static final int generateColor(int r, int g, int b, int a) {
        return ((a & 0xFF) << 24) |
                ((r & 0xFF) << 16) |
                ((g & 0xFF) << 8)  |
                ((b & 0xFF) << 0);
    ...
    public static final int generateColor(float r, float g, float b, float a) {
        int red = (int) (r * 255);
        int green = (int) (g * 255);
        int blue = (int) (b * 255);
        int alpha = (int) (a * 255);
        return generateColor(red, green, blue, alpha);
    }
