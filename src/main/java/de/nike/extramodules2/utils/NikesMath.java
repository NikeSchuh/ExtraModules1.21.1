...
public class NikesMath {
    ...
    public static org.joml.Vector3d lerp(Vector3d start, Vector3d end, float smoothSpeed) {
    ...
    public static float saveTotalPercentage(float number) {
        return Math.max(0.0F, Math.min(number, 1.0F));
    }
}
